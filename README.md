...
- **Watchdog**, and a 3-byte **9600-8N1 UART telemetry** frame (panel + battery
  voltages and battery current; PV current, duty, stage and faults live on the
  `DUTY[5:0]`/`LED`/`FAULT` output pins).
